...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">    
     <center> <h1><b> Ironing Services</b></h1> <br>  </center>
      <div class="w3-row-padding w3-padding-16 w3-center">
  
    <div class="w3-half">
      <img src="../images/ir1.jpg" alt="" style="width:100%" width="450" height="250">
    </div>    

    <div class="w3-half">
      <img src="../images/ir2.jpg" alt="" style="width:100%" width="450" height="250">
    </div>  

    <div class="w3-half">
      <img src="../images/ir3.jpg" alt="" style="width:100%" width="450" height="250">
    </div> 
    <div class="w3-half">
      <img src="../images/ir4.jpg" alt="" style="width:100%" width="450" height="250">
    </div>      
  </div>   
</div>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <form action="../view/laundry.php" method="get">
