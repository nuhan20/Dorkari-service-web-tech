...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">    
     <center> <h1><b>Car Washing Services</b></h1> <br>  </center>
      <div class="w3-row-padding w3-padding-16 w3-center">
  
    <div class="w3-half">
      <img src="../images/cw1.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div>    

    <div class="w3-half">
      <img src="../images/cw2.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div>  

    <div class="w3-half">
      <img src="../images/cw3.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div> 
    <div class="w3-half">
      <img src="../images/cw4.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div>      
  </div>   
</div>
  ...
  <ul>
		<li>Initial diagnosis and washing</li>
...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    ...
    <form action="../view/car.php" method="get">
