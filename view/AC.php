...
<div class="w3-row-padding w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-twothird">    
      <h1>AC Installation & Uninstallation</h1> <br>  
      <div class="w3-row-padding w3-padding-16 w3-center">
  
    <div class="w3-half">
      <img src="../images/ac11.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div>    

    <div class="w3-half">
      <img src="../images/ac12.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div>  

    <div class="w3-half">
      <img src="../images/ac13.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div> 
    <div class="w3-half">
      <img src="../images/ac14.jpg" alt="tv" style="width:100%" width="450" height="250">
    </div>      
  </div>   
</div>
  ...
  <ul>
    <li>Only Service Charges</li>
  </ul>
	<hr> <br><br><br><br>
  <h3>What's Excluded?</h3>
    <ul>
    <li>Component/Material or Parts (if used) i.e. Angle - 1500tk for AC outdoor unit</li>
    <li>Transportation (if applicable).</li>
    <li>Hanging Charge 400tk (If applicate)</li>
    <li>Air conditioner drainage system.</li>
  </ul>
    <hr>
